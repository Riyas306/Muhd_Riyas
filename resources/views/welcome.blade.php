...
<body class="">
    ...
    <section class="container mx-auto mt-10 xl:my-20 xl:px-10 scroll-mt-52" id="about">
        <div class="w-full md:flex justify-center items-center gap-x-2">
            <div class="bg-cover bg-center py-8 w-full relative xl:translate-x-[8rem]">
            ...
            <div class="w-full px-4 md:px-2 xl:px-0">
    ...
    <!-- Projects -->
        <section class="my-10 md:my-20 bg-[#fbfbfb] md:px-10 scroll-mt-52" x-data="{ projectTab: 'all' }" id="project">
            <div class="container mx-auto">
                ...
                <!-- All -->
                <div x-show="projectTab === 'all'" class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center px-4 gap-4">
                    <div
                ...
                <!-- Applications -->
                <div x-show="projectTab === 'application'" class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center px-4 gap-4">
                    <div
                        class="flex justify-center items-center border rounded-md border-[#feb633] shadow-md w-full h-[15rem]">
                        <h2 class="capitalize">
                            it support ticket system
                ...
                <!-- Websites -->
                <div x-show="projectTab === 'website'" class="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 place-items-center px-4 gap-4">
                    <div
                        class="flex justify-center items-center border rounded-md border-[#feb633] shadow-md w-full h-[15rem]">
                        <h2 class="capitalize">
                            infolksgroup
            ...
            <div class="py-10 grid lg:grid-cols-3 gap-5 px-4">
                ...
                <div class="col-span-2 w-full text-sm lg:text-base">
                    ...
                    <div class="w-full flex flex-col gap-2 py-4">
                        ...
                        <textarea id="message" name="message" class="shadow-md rounded-md px-4 py-1" rows="6"
        ...
        <section class="md:px-10 bg-[#f6f8fc]">
            <footer class="container mx-auto py-10 text-sm lg:text-base">
